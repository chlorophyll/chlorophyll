...
EMSCRIPTEN_KEEPALIVE uint32_t hsv2rgb_rainbow(uint8_t hue, uint8_t sat, uint8_t val);
...
EMSCRIPTEN_KEEPALIVE uint32_t hsv2rgb_spectrum(uint8_t hue, uint8_t sat, uint8_t val);
...
EMSCRIPTEN_KEEPALIVE uint32_t hsv2rgb_raw(uint8_t hue, uint8_t sat, uint8_t val);
#define HUE_MAX 191
//
}
#endif
